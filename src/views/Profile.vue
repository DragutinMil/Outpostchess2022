            ...
            <div id="">
                ...
                <div id="middle2">
                    <div class="upload-pic">
                        <div v-if="clickside">
                            <input id="photoupload" type="file" style="display: none" @change="onFileSelected" />

                            <label for="photoupload" class="file-input" />
                    ...
                    <div id="middle2-1">
                        <div>
                            <div v-if="clickside" style="display: flex">
                                <p>Name</p>
                                <input v-model="user.name_first" type="text" class="profile-name2" />
                                <p>Lastname</p>
                                <input v-model="user.name_last" type="text" class="profile-name2" />
                            </div>
                            <p v-else id="profile-name">{{ user.name_first }} {{ user.name_last }}</p>
                        </div>
                        <div class="profile-info1">
                            <div class="profile-info1-1">
                                <p v-if="clickside" class="flex-center" style="padding-right: 4px">Town</p>
                                <input
                                    v-if="clickside"
                                    v-model="user.city"
                                    type="text"
                            ...
                            <p v-if="clickside" class="flex-center">Birth year</p>
                            <input
                                v-if="clickside"
                            ...
                            <div v-if="clickside" class="radiouser flex-center">
                                <input
                                    v-model="sexon"
                                    type="radio"
                                    checked="sexon"
                            ...
                            <p v-else class="padd-text" style="color: #ffffff">
                                {{ user.sex }}
                            </p>
                        </div>
                        <div class="profile-info1-1">
                            ...
                            >
                                <p>Federation:</p>
                                <select id="select-css" v-model="selected">
                                    <option disabled value="">Select</option>
                                    <option v-for="fla in flags" :key="fla.code3" :value="fla.code3">
                                        {{ fla.name }}
                                    </option>
                                </select>
                            </div>
                            <div v-else style="margin-bottom: 0.625rem">
                                <div>
                                    <p style="margin: 0; padding-right: 1.25rem">
                                        Federation:
                                        <span style="color: #c8a07d"> {{ user.federation_details.name }} </span>
                                    </p>
                                </div>
                            </div>
                            <p style="margin-bottom: 0.625rem; padding: 0">Fide ID:</p>
                            <input v-if="clickside" v-model="user.fide_id" type="number" class="profile-name2" />
                            <p v-else style="margin-bottom: 0.625rem; padding: 0 0 0 0.625rem; color: #c8a07d">
                                {{ user.fide_id }}
                            </p>
                        </div>
                    </div>
                    <div id="middle2-button-container">
                        <button v-if="clickside" class="middle2-buttons" type="button" @click="clickside = !clickside">
                            Cancel
                        </button>
                        <button v-else class="middle2-buttons" type="button" @click="clickside = !clickside">
                            Edit Profile
                        </button>
                        <button v-if="clickside" class="middle2-buttons" type="button" @click="userpatch()">
                            Confirm changes
                        </button>
                    </div>
                </div>
                ...
                <div id="middle3">
                        ...
                        <div v-if="clickside && rolecolor1" class="middle3-1">
                            <div v-for="titul1 in titule" :key="titul1.titula_uuid" class="flex-center">
                                <div v-if="rolecolor1 && titul1.rola == 'PLAYER'" class="flex-center">
                                    <input v-model="picked" type="radio" :value="titul1.titula_uuid" name="titlepick" />
                                    <div>
                            ...
                            <p class="remove_click" @click="remove_title('player')">X</p>
                            <div>
                                <p class="left-check-text">Remove title</p>
                            </div>
                        </div>
                        <div v-else-if="clickside && rolecolor2" class="middle3-1" />
                        <!-- ORGANIZER CHOOSE  -->
                    ...
                    value="arbiter"
                  >-->
                                    <p class="remove_click" @click="remove_title('organizer')">X</p>
                                    <div>
                                        <p class="left-check-text">Remove title</p>
                                    </div>
                        ...
                        <!--ARBITER CHOOSE-->
                        <div v-else-if="clickside && rolecolor4" class="middle3-1">
                            <div v-for="titul1 in titule" :key="titul1.titula_uuid" class="flex-center">
                                <div v-if="rolecolor4 && titul1.rola == 'ARBITER'" class="flex-center">
                                    <input
                                        v-model="pickedarb"
                                        type="radio"
                            ...
                            <p class="remove_click" @click="remove_title('arbiter')">X</p>
                            <div>
                                <p class="left-check-text">Remove title</p>
                            </div>
                        </div>
                        <!--TRAINER CHOOSE-->
                        <div v-else-if="clickside && rolecolor5" class="middle3-1">
                            <div v-for="titul1 in titule" :key="titul1.titula_uuid" class="flex-center">
                                <div v-if="rolecolor5 && titul1.rola == 'TRAINER'" class="flex-center">
                                    <input
                                        v-model="pickedtre"
                                        type="radio"
                                        :value="titul1.titula_uuid"
                            ...
                            <p class="remove_click" @click="remove_title('trainer')">X</p>
                            <div>
                                <p class="left-check-text">Remove title</p>
                            </div>
                        </div>
                        ...
                        <div v-else class="middle3-1-1">
                            ...
                            <div style="display: flex">
                                ...
                                >
                                    ...
                                    <!-- <img class="title-arrow" src="../assets/arrow_down.png" alt="">  -->
                                </div>
                                ...
                                <div
                                    ...
                                    class="titles"
                                >
                                    {{ user.titula_trainer_details.titula_short_name }}
                                    <!-- <img class="title-arrow" src="../assets/arrow_down.png" alt="">  -->
                                </div>
                                <div
                                    ...
                                    class="titles"
                                >
                                    {{ user.titula_arbiter_details.titula_short_name }}
                                    <!-- <img class="title-arrow" src="../assets/arrow_down.png" alt="">  -->
                                </div>
                            </div>
                        </div>
                    </div>
                    <div v-if="clickside" class="middle3-1" style="justify-content: flex-start">
                        <p style="color: #6f7381">Rating:</p>
                        <div class="ratings">
                            <p class="text-ratings">Standard:</p>
                            <input v-model="user.rating_standard" type="number" class="rating-patch" />
                        </div>
                        <div class="ratings">
                            <p class="text-ratings">Rapid:</p>
                            <input v-model="user.rating_rapid" type="number" class="rating-patch" />
                        </div>
                        <div class="ratings">
                            <p class="text-ratings">Blitz:</p>
                            <input v-model="user.rating_blitz" type="number" class="rating-patch" />
                        </div>
                    </div>
                ...
                <div id="middle4">
                    <div class="middle3-1">
                        <p :class="{ 'middle4-1': isActive, ratingsi: clickActive1 }" @click="cvdairycal1()">
                            CHESS CV
                        </p>
                        <p :class="{ 'middle4-1': isActive, ratingsi: clickActive2 }" @click="cvdairycal2()">
                            CHESS DIARY
                        </p>
                        <p :class="{ 'middle4-1': isActive, ratingsi: clickActive3 }" @click="cvdairycal3()">
                            CALENDAR
                        </p>
                    </div>
                    <div class="middle3-1">
                        ...
                        <div v-if="clickside" style="display: flex">
                            <select id="select-css" v-model="selectedrole" @change="addrole">
                ...
                <div id="middle5">
                    <div class="middle5-left">
                        <div v-if="clickActive2">
                            <ChessDiary :key="user.user_uuid" :user="user" />
                        </div>
                        <div v-if="clickActive1">
                            <Biography :key="user.user_uuid" :user="user" />
                        </div>
                        <div v-if="clickActive3">
                            <Calendar :key="user.user_uuid" :user="user" />
                        </div>
                    </div>
                    <div>
                        <!--PLAYER PART -->
                        <div v-if="activePlayer && user.rola.indexOf('PLAYER') !== -1">
                                ...
                                <div class="mid5-padd">
                                    ...
                                    <div>
                                        <input
                                            ...
                                            class="inputcurplay"
                                        />
                                        <p v-else class="gold" style="margin-top: 1.25rem">
                                            {{ user.current_clubs }}
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="middle5-right-grid">
                                <div class="mid5-padd">
                                    ...
                                    <div>
                                        <input
                                            v-if="
                                                (user.current_playing_bool && user.current_playing == '') || clickside
                                            "
                            ...
                            <div class="middle5-right-grid2" style="min-height: 170px">
                                <div class="mid5-padd" style="padding: 0 0 0 0.625rem">
                                    <p class="middle5-text" style="margin-bottom: 0.625rem">Open to new engagements</p>

                                    <div>
                                        <div
                                            class="engage-grid stikl"
                                            :class="{
                                                stikl1: user.open2new_eng_club === false || engageclub === false,
                                            }"
                                        >
                                        ...
                                        <div
                                            ...
                                            :class="{
                                                stikl1:
                                                    user.open2new_eng_tournament === false ||
                                                    engagetournament === false,
                                            }"
                                        >
                                        ...
                                        <div
                                            class="engage-grid stikl"
                                            :class="{
                                                stikl1: user.open2new_eng_event === false || engageevent === false,
                                            }"
                                        >
                                ...
                                <div class="mid5-padd" style="padding: 0 0 0 0.625rem">
                                    <p class="middle5-text" style="margin-bottom: 0.625rem">
                                    ...
                                    <p v-for="listpla in my_interested_list" :key="listpla.target_uuid" class="gold2">
                                        ...
                                        >
                                            - {{ listpla.target_object.name_first }}
                                            {{ listpla.target_object.name_last }}
                                        </router-link>
                                    </p>
                                    <p v-for="listclub in my_intclub_list" :key="listclub.target_uuid" class="gold2">
                                        ...
                                        >
                                            - {{ listclub.target_object.name_first }}
                                            {{ listclub.target_object.name_last }}, club:{{
                                                listclub.target_object.club_name
                                            }}
                                        </router-link>
                                    </p>
                                </div>
                            ...
                            <div id="middle5-right-end">
                                ...
                                <div v-if="changed_compensation" class="slider">
                                    <p>{{ rangeclub[0] }}</p>
                                    <p class="slider-text" />
                                    <p>{{ rangeclub[1] }}</p>
                                </div>
                                <div v-else class="slider">
                                    <p>{{ user.comp_per_game_from }}</p>
                                    <p style="padding-left: 3.125rem">
                                        {{ user.comp_per_game_to }}
                                    </p>
                                </div>
                                <div v-if="changed_compensation">
                                    <button class="button-range" type="button" @click="compensation">Save</button>
                                </div>
                            </div>
                        </div>
                        <!-- END PLAYER PART  -->
                            ...
                            <div class="middle5-right-grid">
                                <div class="mid5-padd">
                                    <div style="height: 4rem; display: flex">
                                        ...
                                        <img v-if="switch3" class="plava-kugla" src="../assets/plavakugla.png" alt="" />
                                    </div>
                                    ...
                                    <div>
                                        <input
                                            v-if="
                                                (user.club_current_playing_bool && user.club_current_playing == '') ||
                                                clickside
                                            "
                                ...
                                <div class="mid5-padd">
                                    <p class="middle5-text" style="padding-bottom: 1.875rem">Looking for new player:</p>
                        ...
                        <div v-else-if="activeOrg && this.user.rola.indexOf('ORGANIZER') !== -1">
                            <div id="middle5-right-startorg">
                                ...
                                <div class="mid5-padd">
                                    ...
                                    >
                                        ...
                                        <p v-if="user.organizer_current_event">
                                            From {{ user.organizer_current_event.event_date_from }} to
                                            {{ user.organizer_current_event.event_date_to }}
                                        </p>
                                        <p v-if="user.organizer_current_event">
                            ...
                            <div class="middle5-right-grid">
                                ...
                                <div class="mid5-padd flex-center">
                                    <div class="borderbutton flex-center" @click="newevent = !newevent">
                                        <img src="../assets/createevent2.png" alt="" />
                                        <p>Create an event</p>
                                    </div>
                                </div>
                            ...
                            <div id="middle5-right-startorg" style="margin: 0">
                                <div v-if="newevent" style="display: flex">
                                    <div style="height: 4rem">
                                        ...
                                        <div class="list-events">
                                            ...
                                            <p>
                                                <input v-model="new_event_to" type="date" class="profile-name2 line2" />
                                            </p>
                                        </div>
                                    </div>
                                    <div>
                                ...
                                >
                                    ...
                                    <div v-for="(event, index) in events" :key="event.event_uuid" style="display: flex">
                                        <p
                                        ...
                                        <p style="cursor: pointer" class="gold-event">
                                            {{ event.event_name }}
                                        </p>
                                        <p style="cursor: pointer" @click="delete_event(event)">x</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <!-- Trainer -->
                        <div v-else-if="activeTre && user.rola.indexOf('TRAINER') !== -1">
                            <div id="middle5-right-startorg" style="background-color: #11c6d1">
                                ...
                                <div
                                    v-if="user.trainer_price_lesson !== null && enter_again == false"
                                    class="middle5-text w700"
                                    id="trainer-price-number"
                                >
                                ...
                                <div
                                    v-if="enter_price == true && (enter_again == true) & (text2 == false)"
                                    id="trainer_input_price"
                                >
                                    <input
                                        type="number"
                            ...
                            <div class="middle5-right-grid">
                                <div class="mid5-padd" style="padding-top: 2rem">
                                    <p class="middle5-text">Looking for new students?</p>
                                    <div>
                            ...
                            <div class="middle5-right-grid" style="margin: 0">
                                <div class="mid5-padd">
                                    <div class="middle5-text flex_space">
                                        <p>Students</p>
                                        <p class="tranier_new_student" @click="new_student_entry = !new_student_entry">
                                            New +
                                        </p>
                                    </div>
                                    <div
                                        class="middle5-text2"
                                        style="display: flex"
                                        v-for="(student, index) in user.trainer_list_of_students"
                                        :key="student"
                                    >
                                        ...
                                        <div class="flex_space" style="padding-left: 0.375rem">
                                            {{ student }}
                                            <p
                                                class="tranier_new_student"
                                                v-if="new_student_entry"
                                                @click="delete_student(student)"
                                            >
                                                delete
                                            </p>
                                        </div>
                        ...
                        <div v-else-if="activeArb && this.user.rola.indexOf('ARBITER') !== -1">
                            <div id="middle5-right-startorg">
                                ...
                                <div class="mid5-padd">
                                    <div style="height: 4rem; display: flex; position: relative">
                                        <img
                                            v-if="
                                                user.arbiter_current_event_name != null &&
                                                enter_event == false &&
                                                user.arbiter_currently_active == true
                                            "
                                            class="plava-kugla2"
                                            src="../assets/plavakugla.png"
                                            alt=""
                            ...
                            <div class="middle5-right-grid">
                                <div class="mid5-padd flex-center">
                                    <p class="middle5-text">Looking for new engagement?"</p>
                                    <div>
                                        <div class="switch-style">
                                            <b-form-checkbox
                                                class="switch"
                  ...
                  >
                    ...
                    <p>Create an event</p>
                        ...
                        <!-- Other -->
                        <div v-else-if="activeOth && user.rola.indexOf('OTHER') !== -1" style="opacity: 0.5">
...
export default {
    ...
    data() {
        return {
            ...
            clickside: false,
            engageclub: function () {
                return this.user.open2new_eng_club;
            },
            engageevent: function () {
                return this.user.open2new_eng_event;
            },
            engagetournament: function () {
                return this.user.open2new_eng_tournament;
            },
            about: "",
            flags: [],
            fla: "",
    ...
    methods: {
        ...
        role_indicator: function (rola) {
            ...
            this.activeTre = false;
            this.activeArb = false;
            this.activeOth = false;
