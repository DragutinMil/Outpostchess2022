                ...
                <div id="middle2">
                    ...
                    <div id="middle2-1">
                        ...
                        <div class="profile-info1">
                            ...
                            <p class="padd-text" style="color: #ffffff">
                                {{ user.sex }}
                            </p>
                        </div>
                        <div class="profile-info1-1">
                ...
                <div id="middle5">
                    <div class="middle5-left">
                        ...
                        <div v-if="clickActive1">
                            <BiographyPublic :key="user.user_uuid" :user="user" />
                        </div>
                    ...
                    <div>
                        ...
                        <div v-if="activePlayer && user.rola.indexOf('PLAYER') !== -1">
                            <div class="middle5-right-grid">
                                <div class="mid5-padd">
                                    ...
                                    <div>
                                        <p class="gold" style="margin-top: 1.25rem">
                                            {{ user.current_clubs }}
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="middle5-right-grid">
                                <div class="mid5-padd">
                                    ...
                                    />
                                    <div>
                                        <p v-if="user.current_playing_bool" class="gold" style="margin-top: 1.875rem">
                                ...
                                <div class="mid5-padd">
                                    ...
                                    <div id="form-middle5">
                                        <img
                                            ...
                                            alt=""
                                        />
                                        <p style="margin: 0; padding: 0.5rem 0 0 0">Unknown</p>
                                    </div>
                                </div>
                            </div>
                            <div class="middle5-right-grid" style="height: 10.625rem">
                                ...
                                <div class="mid5-padd flex-center">
                                    <div>
                                        ...
                                        >
                                            <p style="font-size: 0.75rem" @click="interested_player">
                                        ...
                                        >
                                            <p style="font-size: 0.75rem">Remove from shortlist</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div v-else-if="activeClub && user.rola.indexOf('CLUB') !== -1">
                            ...
                            <div class="middle5-right-grid">
                                ...
                                <div class="mid5-padd">
                                    ...
                                    <div class="switch-style">
                                        <b-form-checkbox switch disabled :checked="user.club_looking_for_new_player" />
                                    </div>
                                </div>
                            </div>
                            <div class="middle5-right-grid">
                                ...
                                <div class="mid5-padd flex-center">
                                    <div>
                                        <div style="margin-bottom: 0.625rem" class="borderbutton flex-center">
                                            <p style="font-size: 0.75rem" @click="interested_club">
                            ...
                            <div class="middle5-right-grid">
                                <div class="mid5-padd flex-center" style="height: 10.625rem">
                                    <div class="borderbutton flex-center">
                    ...
                    <v-container class="switch-container">
                      ...
                      />
                            ...
                            <div class="middle5-right-grid">
                                ...
                                <div class="mid5-padd flex-center">
                                    <div class="borderbutton flex-center" @click="interested_event">
                            ...
                            <div class="mid5-padd listevent" style="padding: 0.625rem">
                                <p class="middle5-text">My events:</p>
                                <div v-for="(event, index) in events" :key="event.event_uuid">
                                    <div v-if="event.organiser_uuid == user.user_uuid" style="display: flex">
                                        <p style="padding-right: 0.5rem; margin-left: 1.25rem">{{ index + 1 }}.</p>
                                        <p class="gold-event">
                                            {{ event.event_name }}
                                        </p>
                                    </div>
                        ...
                        <!--TRAINER -->
                        <div v-if="activeTre && user.rola.indexOf('TRAINER') !== -1">
                            ...
                            <div class="middle5-right-grid">
                                ...
                                <div class="mid5-padd flex-center">
                                    <div class="borderbutton flex-center" style="border: 1px solid #c8a07d">
                                        <p>EASY PAY</p>
                                    </div>
                                </div>
                                <!--      <div class="mid5-padd flex-center">
                                ...
                                <div class="mid5-padd flex-center">
                                    <div>
                                        <div
                                            ...
                                            class="borderbutton flex-center"
                                        >
                                            <p style="font-size: 0.75rem" @click="interested_trainer">
                                                Interested in this Trainer
                                            </p>
                                        </div>
                                        <div v-if="clicked_interested_trainer2">
                                            <div v-for="listpla in my_int_trainer_list" :key="listpla.created_date">
                                                <div
                                                    v-if="listpla.target_uuid == user.user_uuid"
                                                    class="borderbutton flex-center"
                                                >
                                                    <div style="font-size: 0.75rem">
                                                        <p @click="interested_trainer_del">Remove from shortlist</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <!--END TRAINER-->
                        <!--ARBITER-->
                        <div v-if="activeArb && user.rola.indexOf('ARBITER') !== -1">
                            <div id="middle5-right-startorg">
                                <p class="middle5-text">My Event is currently active:</p>
                                <div class="mid5-padd">
                                    ...
                                    <div>
                                        <div
                                            ...
                                            style="padding-left: 0.625rem; color: #ffc796"
                                        >
                                ...
                                <div class="mid5-padd flex-center">
                                    <div>
                                        <div
                                            ...
                                            class="borderbutton flex-center"
                                        >
                                            <p style="font-size: 0.75rem" @click="interested_arbiter">
                                                Interested in this Arbiter
                                            </p>
                                        </div>
                                        <div v-if="clicked_interested_arbiter2">
                                            <div v-for="listpla in my_int_arbiter_list" :key="listpla.created_date">
                                                <div
                                                    v-if="listpla.target_uuid == user.user_uuid"
                                                    class="borderbutton flex-center"
                                                >
                            ...
                            <div id="middle5-right-startorg" style="margin: 0"></div>
                        </div>
                        <!--END ARBITER -->
                    </div>
                </div>
