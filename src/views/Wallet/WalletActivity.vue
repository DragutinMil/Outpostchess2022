...
import OneActivityCard from "@/components/Wallet/OneActivityCard";

export default {
  name: "WalletActivity",
  components: {OneActivityCard, Notifications, Search, SideBar}
}
</script>
