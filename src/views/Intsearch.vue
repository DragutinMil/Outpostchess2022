<template>
    <div class="profile">
        <SideBar />
        <div :class="{ 'right-profile': isActive, 'side-appear': clickside1 }">
            <div />
            <div id="right-middle">
                <div style="padding-bottom: 2.5rem" />
                <div id="input-filter">
                    <div id="filter_height">
                        <img id="imgsearch" src="../assets/search_24px.png" alt="" @click="confirmSearch()" />
                    </div>
                    <input
                        v-model="input_text"
                        type="search"
                    ...
                    >
                        <div style="display: flex">
                            ...
                            <img id="img-category" src="../assets/linije.png" alt="" />
                        </div>
                    </div>
                </div>
                <!--DECLARATION-->
                <div class="search">
                    ...
                    <div class="search-header" style="padding-right: 0.5rem">Club</div>
                </div>
                    ...
                    <div v-for="(usersrc, index) in usersearchreact" :key="usersrc.user_uuid" class="search">
                        ...
                        <div class="search-res">
                            <div class="search-res3">
                                <div v-if="usersrc.open2new_eng_club == true" class="inetrestedin">Club</div>
                                <div v-if="usersrc.open2new_eng_tournament == true" class="inetrestedin">
                                    Tournament
                                </div>
                                <div v-if="usersrc.open2new_eng_event == true" class="inetrestedin">Event</div>
                            </div>
                        </div>
                        <div class="search-res2">
                            <div v-for="titles in titule" :key="titles.titula_uuid">
                                ...
                                <div v-if="titles.titula_uuid == usersrc.titula_organizer">IO&nbsp;&nbsp;</div>
                ...
                <!--ALL USERS -->
                <div v-else>
                    <div v-for="(alluser, index) in usersearch" :key="alluser.user_uuid">
                        <div class="search">
                            <div class="search-res">
                                {{ index + 1 }}
                            </div>
                            ...
                            <div class="search-res3">
                                <div v-if="alluser.open2new_eng_club == true" class="inetrestedin">Club</div>
                                <div v-if="alluser.open2new_eng_tournament == true" class="inetrestedin">
                                    Tournament
                                </div>
                                <div v-if="alluser.open2new_eng_event == true" class="inetrestedin">Event</div>
                            </div>
                            <div class="search-res2">
                                <div v-for="titles in titule" :key="titles.titula_uuid">
                                    ...
                                    <div v-if="titles.titula_uuid == alluser.titula_organizer">IO&nbsp;&nbsp;</div>
            ...
            <div v-if="clickside1" id="side-bar">
                ...
                <div v-if="clickcountry" class="clicksearch">
                    <select id="select-css" v-model="country">
                ...
                <div v-if="clickgender" class="clicksearch">
                    <div class="flex-center">
                        <input
                            ...
                            value="Male"
                        />
                        <p style="margin: 0; padding-right: 10px">Male</p>
                        <input
                            v-model="sexon"
                            type="radio"
                            checked="sexon"
                ...
                <div v-if="clicktitle" class="clicksearch">
                    <div class="custom-select">
                        <select v-model="titleselected" class="select-text">
                            <option value="">
                                <p style="color: #ffffff">Title search</p>
                            </option>
                            <option
                ...
                <div v-if="clickinterested" class="clicksearch paddd">
                    <div id="search-interest">
                        <div class="check_search-interest">
                            <input v-model="interestedclub" type="checkbox" class="radiobutton" />
                            <p style="margin: 0">Club</p>
                        </div>
                        <div class="check_search-interest">
                            <input v-model="interestedtour" type="checkbox" class="radiobutton" />
                            <p style="margin: 0">Tournamenr</p>
                        </div>
                        <div class="check_search-interest">
                            <input v-model="interestedevent" type="checkbox" class="radiobutton" />
                            <p style="margin: 0">Event</p>
                        </div>
                    </div>
                </div>
                <div class="flex center buttonsearch">
                    <button class="middle2-buttons" type="button" style="margin-top: 2rem" @click="confirmSearch">
                        Search
                    </button>
                </div>
            </div>
...
export default {
    ...
    mounted() {
        ...
        fetch(process.env.VUE_APP_URL + "/users_search", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                Authorization: `Bearer ${localStorage.getItem("token")}`,
